...
Namespace Interfaz
    Module Pestañas
        ...
        Public Sub Visibilidad(gridMostrar As Grid, tag As String, origen As Object)
            ...
            tbTitulo.Text = recursos.GetString("Webs_Title") + " (" + Package.Current.Id.Version.Major.ToString + "." + Package.Current.Id.Version.Minor.ToString + "." + Package.Current.Id.Version.Build.ToString + "." + Package.Current.Id.Version.Revision.ToString + ")"

            If Not tag = Nothing Then
                tbTitulo.Text = tbTitulo.Text + " • " + tag
            End If

            Dim gridWebs As Grid = pagina.FindName("gridWebs")
            gridWebs.Visibility = Visibility.Collapsed
